...
public class Banco {
    ...
    public Banco() {
        Empleado Gerente1 = new Empleado("Gerente1","23","Juan","Perez", LocalDate.now(),"Morelia","Mich","12222","12222","Av Tec de morelia", Sucursales.Acueducto, Rol.Gerente,500000000, LocalDate.of(2020,07,23));
        listaEmpleado.put(Gerente1.getUsuario(), Gerente1);
